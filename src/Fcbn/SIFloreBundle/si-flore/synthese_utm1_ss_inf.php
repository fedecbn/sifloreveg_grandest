...
SELECT mai.nom_maille as cd_sig, ind.cd_ref,count(*) AS nb_obs, count(
    ...
    WHERE  mai.nom_maille::text = lien.nom_maille::text and lien.id_flore_fcbn=obs.id_flore_fcbn and obs.code_taxon=ind.code_taxon and ind.cd_ref='".$_GET['cd_ref']."'
