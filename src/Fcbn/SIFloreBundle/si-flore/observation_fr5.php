...
$requete = "--observation_fr5
select * from exploitation.obs_maille_fr5 obs, exploitation.taxref_v5_new tax
	WHERE obs.cd_ref=tax.cd_ref and (tax.cd_ref='".$_GET['cd_ref']."' or tax.cd_taxsup='".$_GET['cd_ref']."' or tax.cd_taxsup2='".$_GET['cd_ref']."' or tax.cd_taxsup3='".$_GET['cd_ref']."' ) and cd_sig= '".$_GET['id_obj']."'
 ;
";
