...
$insert_commandes="INSERT INTO exploitation.commentaires (prenom,nom,email,comment,utilisateur,cd_ref,id_obj,id_flore_fcbn, date_com, type_com, priorite_com, action_com,nom_complet) values ('".$_POST['prenom']."','".$_POST['nom']."','".$_POST['email']."','".$_POST["comment"]."','".$_SERVER['PHP_AUTH_USER']."',".$_POST['cd_ref'].",'".$_POST['id_obj']."','".$_POST['id_flore_fcbn']."',CURRENT_DATE,'".$_POST['type_com']."','".$_POST['priorite_com']."','".$_POST['action_com']."','".$_POST['nom_complet']."') returning id;";
