...
$requete = "select nom_taxon_mere , cd_ref_taxref, code_commune_mere AS insee_comm, ST_ASGeoJSON(ST_Transform(geom,900913)) AS lieu from observation_taxon_commune
	WHERE cd_ref_taxref= '".$_GET['cd_ref']."'
 ;";
