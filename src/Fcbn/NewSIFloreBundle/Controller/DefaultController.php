...
class DefaultController extends Controller {
    ...
    public function indexAction() {
        ...
        //return new response($this->get('new_si_flore.layer')->getParams());
        ...
        return $this->render('FcbnNewSIFloreBundle:Default:index.html.twig', array('taxon' => $taxon, 'region' => $region, 'taxonoption' => $taxopt, 'syntheseoption' => $synopt, 'layers'=>$layersData));
    }
